...
def main():
    parser = argparse.ArgumentParser(
        description="HN TechPulse: Generate tech news briefing from Hacker News"
    )
    parser.add_argument(
        "--date",
        type=validate_date,
    ...
    parser.add_argument(
        "--steps",
        type=str,
        default="fetch,enrich,script,translate",
        help="Steps to run (comma-separated: fetch,enrich,script,translate,markdown,html)",
    )
    parser.add_argument(
