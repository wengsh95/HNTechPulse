...
export const StoryCompactCard: React.FC<ElementProps> = ({ elementProps, width, height }) => {
  ...
  const hasBody = Boolean(readerHook || microTakeaway);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body: reader hook + micro takeaway */}
        {hasBody && (
          <div
            style={{
