...
export const StoryCompactCard: React.FC<ElementProps> = ({ elementProps, width }) => {
  ...
  const layout = useMemo(() => {
    ...
    return { cardW, cardH, hasImage, isLogo, isScreenshot, mediaW, mediaH, gap, availableTextW, textMaxW, showOriginalTitle, showMetrics };
  }, [width, d, compact, padX, padY, imageSrc, imageType, sourceTitle, displayTitle, score, commentCount, heatLevel]);
  const { cardW, cardH, hasImage, isLogo, isScreenshot, mediaW, mediaH, gap, textMaxW, showOriginalTitle, showMetrics } = layout;
