...
STORIES = [
    ...
    (
        "1",
        "Anthropic raises $10B at $200B valuation",
        "https://anthropic.com/news/10b",
        1200,
        540,
    ...
    (
        "2",
        "Critical RCE in OpenSSH disclosed — patch now",
        "https://openssh.com/advisory",
        980,
        320,
        ["prod boxes need patching tonight"],
        "news",
    ),
    (
        "3",
        "OpenAI announces GPT-6 with 10x context window",
        "https://openai.com/blog/gpt6",
        1800,
        800,
        ["huge leap, but also huge infra bill"],
        "news",
    ),
    (
        "4",
        "Nvidia unveils Blackwell Ultra GPU at GTC",
        "https://nvidia.com/blackwell-ultra",
        720,
        210,
        ["perf/watt is the real story"],
        "news",
    ),
    (
        "5",
        "Major data breach at X exposes 200M user records",
        "https://x.com/breach",
        1500,
        1100,
        ["the second one this quarter"],
        "news",
    ),
    (
        "6",
        "EU passes landmark AI Act amendment on open source",
        "https://europa.eu/ai-act-amendment",
        600,
        180,
        ["big deal for OSS devs"],
        "news",
    ),
    (
        "7",
        "Linux kernel 7.0 released with Rust-first drivers",
        "https://kernel.org/7.0",
        540,
        160,
        ["finally"],
        "news",
    ...
    (
        "8",
        "Show HN: I built a faster Postgres in 6 months",
        "https://github.com/x/fastpg",
        420,
        95,
        ["neat project"],
        "show",
    ...
    (
        "9",
        "Show HN: A terminal UI for Kubernetes",
        "https://github.com/x/kui",
        280,
        60,
        ["looks polished"],
        "show",
    ...
    (
        "10",
        "Show HN: Local-first note app with CRDT sync",
        "https://github.com/x/notes",
        180,
        40,
        ["i use obsidian but cool"],
        "show",
    ),
    (
        "11",
        "Show HN: GPU-accelerated regex engine",
        "https://github.com/x/gpuregex",
        150,
        25,
        ["benchmark numbers?"],
        "show",
    ...
    (
        "12",
        "Ask HN: How do you handle on-call at small startups?",
    ...
    (
        "13",
        "Ask HN: What's your favorite debugging tool in 2026?",
        "https://news.ycombinator.com/item?id=13",
        220,
        150,
        ["just gdb"],
        "ask",
    ...
    (
        "14",
        "Ask HN: Should I learn Rust or Go in 2026?",
        "https://news.ycombinator.com/item?id=14",
        480,
        380,
        ["hot debate as always"],
        "ask",
    ),
    (
        "15",
        "Ask HN: Why is my Lambda cold start 8s?",
    ...
    (
        "16",
        "Tutorial: Building a vector DB from scratch",
        "https://blog.x/vector-db",
        380,
        90,
        ["nice writeup"],
        "tutorial",
    ...
    (
        "17",
        "Why I switched from VSCode to Zed (after 5 years)",
        "https://blog.x/zed",
        200,
        110,
        ["zed is fast but..."],
    ...
    (
        "18",
        "A curated list of 200 CLI tools",
        "https://github.com/x/awesome-cli",
        90,
        30,
        ["bookmarked"],
        "resource",
    ...
    (
        "19",
        "Deep dive: How Linux page tables work",
        "https://blog.x/page-tables",
        150,
        50,
        ["loved it"],
        "tutorial",
    ...
    (
        "20",
        "On the state of developer experience in 2026",
        "https://blog.x/dx-2026",
        110,
        40,
        ["decent take"],
        "opinion",
...
def llm_decision(idx, item):
    ...
    if is_news_event:
        ...
        category = (
            ...
            if "rce" in title or "breach" in title
            else "hardware"
            if "nvidia" in title or "gpu" in title
            else "policy"
            if "eu" in title or "act" in title
            else "infra"
        )
    elif is_ask_hn:
        news_focus = 1
...
def main():
    ...
    print(
        f"{'#':<3} {'ID':<4} {'Type':<10} {'NF':<3} {'NW':<3} {'EScore':<8} {'HN':<5} {'Title'}"
    )
    print("-" * 110)
