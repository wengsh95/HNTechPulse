...
这不是重点深讲，只需要让听众知道：发生了什么、HN 为什么聊、社区氛围是什么、一个可记住的角度。
...
- 第一句必须有主语、动作、对象。
- 第二句必须带少量社区氛围判断，根据 `discussion_mode` 写：debate 写分歧，field_notes 写经验补充，nostalgia 写怀旧点，correction 写纠错点。
- 速读卡片会显示一张小图和系统注入的社区氛围摘要；旁白不要重复画面文字，要补充判断。
