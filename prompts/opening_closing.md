...
目标：开场和结尾要适合 B 站发布。它们应该像成熟科技内容账号的口播，不是“今日信号”式内部标签，也不是机械串标题。开场负责 3 秒留存，结尾负责把观众送到评论区。
...
- 可以自然引导关注，但不要“点赞投币三连”。
- 不使用“今天的主线是”这类开场框架词。
- 结尾问题必须包含当天至少一个具体对象、成本或场景，不能固定问“效率还是稳定性”。
- 同一个问题模板不要跨天连续复用；当分类混杂时，优先问“这类代价应该由平台、开发者还是用户承担”。
